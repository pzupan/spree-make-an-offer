...
desc 'Generate documentation for the make_an_offer extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'MakeAnOfferExtension'
...
desc 'Test the make_an_offer extension.'
...
namespace :test do
  desc 'Functional test the make_an_offer extension.'
  ...
  desc 'Unit test the make_an_offer extension.'
